...
class ProcessWebhook extends ProcessWebhookJob
{
    ...
    public function handle(): void
    {
        ...
        $skippedReason = match ($type) {
            ...
            'customer.created' => $this->dispatchSimpleEvent($data, $timestamp, $type, CustomerCreated::class, (($data['type'] ?? 'individual') === 'team' ? Components\CustomerTeam::class : Components\CustomerIndividual::class)),
            'customer.updated' => $this->dispatchSimpleEvent($data, $timestamp, $type, CustomerUpdated::class, (($data['type'] ?? 'individual') === 'team' ? Components\CustomerTeam::class : Components\CustomerIndividual::class)),
            'customer.deleted' => $this->dispatchSimpleEvent($data, $timestamp, $type, CustomerDeleted::class, (($data['type'] ?? 'individual') === 'team' ? Components\CustomerTeam::class : Components\CustomerIndividual::class)),
            'customer.state_changed' => $this->dispatchSimpleEvent($data, $timestamp, $type, CustomerStateChanged::class, (($data['type'] ?? 'individual') === 'team' ? Components\CustomerStateTeam::class : Components\CustomerStateIndividual::class)),
